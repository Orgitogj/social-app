...
Deno.serve(async request => {
  ...
  if (payload.action === 'export') {
    const [profile, privateProfile, posts, comments, follows, bookmarks, notifications, conversations, messages, reports] = await Promise.all([
