...
export type StoryTrayItem = { author: Profile; story_count: number; unviewed_count: number; latest_story_at: string; has_close_friends: boolean; is_own: boolean; muted?: boolean; next_expires_at?: string | null };
